...
Create the dataset of teams, divisions, and seasons.
...
Get data from hockey-reference.

```{r}
# we have to make adjustments for the Coyotes' name change from Phoenix to Arizona, and the addition of Vegas
tm = teams[1]
teams[2] = 'PHX'
for(tm in teams){
...
# scraping is not currently working
mydata = read_csv("~/Dropbox/R/nhlPtPct.csv")
```

#### Plots

We need to set colors for each team.
...
Plot using stat_smooth(method = 'loess').
